...
if (!function_exists('create_social_sharing')) {
    ...
    function create_social_sharing() {
                    ...
                    if ($show_twitter == "yes") {
                        ...
                        $html .= '<a href="#" title="' . __("Share on Twitter", 'create') . '" onclick="popUp=window.open(\'http://twitter.com/home?status=' . urlencode( get_permalink() ) . '\', \'popupwindow\', \'scrollbars=yes,width=800,height=400\');popUp.focus();return false;">';
