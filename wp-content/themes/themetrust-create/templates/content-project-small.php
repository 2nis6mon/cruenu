						...
						<div class="inside">
							...
							<div class="details <?php echo $details_class; ?>" style="border-color: <?php echo $portfolio_config['hover_text_color']; ?>;">
								...
								<div class="title-small" >
									<?php the_title( '<span class="entry-title" style="color: '.$portfolio_config['hover_text_color'].'!important;">', "</span><br/>\n" );?>
				<?php if( $subtitle ) { ?>
					<span class="entry-subtitle" style="color: <? echo $portfolio_config['hover_text_color']; ?>!important;font-size: 0.8em; font-style: italic;">
						<?php echo $subtitle; ?>
					</span>
				<?php } ?>
								</div>
