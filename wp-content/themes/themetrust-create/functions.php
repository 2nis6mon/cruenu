...
add_filter( 'document_title_separator', 'create_document_title_separator',10 );
function create_document_title_separator( $sep ){
	return '|';
}
...
if ( ! function_exists( 'create_scripts_n_styles' ) ) {
	function create_scripts_n_styles() {
		...
		wp_enqueue_script( 'create-theme_trust_js', get_template_directory_uri() . '/js/theme_trust.js', array( 'jquery' ), '1.1', true );
	...
	function create_theme_head() { ?>
		...
		<style>
			...
			if( $color['main_menu'] ) { ?>
				.main-nav ul li,
				.secondary-nav span,
				.secondary-nav a { color: <?php echo $color['main_menu']; ?> !important; }
			<?php } ?>
			...
			if( isset($color['main_menu_metabox']) ) { ?>
				...
				body #site-header.transparent.light .secondary-nav a { color: <?php echo $color['main_menu_metabox']; ?> !important; }
			<?php } ?>
			...
			if( $color['main_menu_hover'] ) { ?>
				...
				.main-nav ul li.current-projects-ancestor { color: <?php echo $color['main_menu_hover']; ?> !important;}
			...
			if( isset($color['main_menu_hover_metabox']) ) { ?>
				...
				body #site-header.transparent.light .secondary-nav a:hover { color: <?php echo $color['main_menu_hover_metabox']; ?> !important; }
			...
			if( $color['sticky_main_menu'] ) { ?>
				...
				.sticky .secondary-nav a { color: <?php echo $color['sticky_main_menu']; ?> !important; }
			<?php } ?>
			...
			if( $color['sticky_main_menu_hover'] ) { ?>
				...
				.sticky .secondary-nav span:hover, .sticky .secondary-nav a:hover { color: <?php echo $color['sticky_main_menu_hover']; ?> !important; }
			<?php } ?>
			...
			if( $color['drop_down_link'] ) { ?>
				.main-nav ul ul li, .sticky .main-nav ul ul li { color: <?php echo $color['drop_down_link']; ?> !important; }
			<?php } ?>
